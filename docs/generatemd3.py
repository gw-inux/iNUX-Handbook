...
# ---------------------------
# EU co-funding block (append to bottom of every page)
# ---------------------------

EU_BLOCK_MARKER = "eu-funded.jpg"
...
def ensure_eu_block_at_end(md_body: str) -> str:
    """
    Append the EU funding block to the end of the markdown body if not present.
    Idempotent: if the marker/logo is already found anywhere in the body, do nothing.
    """
    if EU_BLOCK_MARKER in md_body:
        return md_body
